...
import { COLOR_THEMES, NODE_SIZE } from '../src/constants/theme';
import type {
  AnalyticsViewProps,
  CategoryMap,
  EventItem,
...
const styles = StyleSheet.create({
  ...
  // CalendarView styles moved to src/features/calendar/index.tsx
  tabBar: {
    flexDirection: 'row',
    height: 52,
  ...
  // Timeline styles moved to DailyTimeline.tsx
  // Modal styles moved to src/features/calendar/index.tsx
  sheetHeader: {
    flexDirection: 'row',
